...
if($current_query->term_id == 48 || $list_type == 3){
	$first_post = $list_type == 3 ? get_post(1238) : get_post(665); ?>
			<a href="<?php echo get_permalink($first_post->ID); if($list_type == 3) echo '?material='.$current_query->slug; ?>" class="<?php echo $list_type == 3 ? 'col-xs-6 col-sm-2 col-sm-x5' : 'col-xs-12 col-sm-6 col-md-4 col-lg-3'; ?>">
<?php
